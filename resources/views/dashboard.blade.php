			...
			<div class="card overflow-hidden">
				...
				<div class="card-body">
					<div class="d-flex align-items-center mt-auto">
						...
						<div>
							<a href="#" class="font-weight-semibold">Operation Department</a>
			...
			<div class="card overflow-hidden">
				...
				<div class="card-body">
					<div class="d-flex align-items-center mt-auto">
						<div class="avatar brround avatar-md mr-3" style="background-image: url(../../assets/images/users/16.jpg)"></div>
						<div>
							<a href="#" class="font-weight-semibold">Yard Department</a>
				...
				<div class="card overflow-hidden">
					...
					<div class="card-body">
						<div class="d-flex align-items-center mt-auto">
							<div class="avatar brround avatar-md mr-3" style="background-image: url(../../assets/images/users/16.jpg)"></div>
							<div>
								<a href="#" class="font-weight-semibold">Yar Department</a>
