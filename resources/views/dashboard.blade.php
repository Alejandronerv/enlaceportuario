		...
		<div class="col-xl-4 col-lg-6 col-md-12">
			<div class="card overflow-hidden">
				<div class="item7-card-img">
					<a href="#"></a>
					<img src="/images/photos/1.jpg" alt="img" class="cover-image w-100">
				</div>
				<div class="card-body">
				...
				<div class="card-body">
					<div class="d-flex align-items-center mt-auto">
						...
						<div>
							<a href="profile.html" class="font-weight-semibold">Operation Department</a>
			...
			<div class="card overflow-hidden">
				...
				<div class="card-body">
					<div class="d-flex align-items-center mt-auto">
						<div class="avatar brround avatar-md mr-3" style="background-image: url(../../assets/images/users/16.jpg)"></div>
						<div>
							<a href="profile.html" class="font-weight-semibold">Yard Department</a>
				...
				<div class="card overflow-hidden">
					...
					<div class="card-body">
						<div class="d-flex align-items-center mt-auto">
							<div class="avatar brround avatar-md mr-3" style="background-image: url(../../assets/images/users/16.jpg)"></div>
							<div>
								<a href="profile.html" class="font-weight-semibold">Yar Department</a>
				...
				<div class="card overflow-hidden">
					...
					<div class="card-body">
						<div class="d-flex align-items-center mt-auto">
							...
							<div>
								<a href="profile.html" class="font-weight-semibold">Yard Department</a>
								<small class="d-block text-muted">7 days ago</small>
							</div>
						</div>
					</div>
				</div>
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="row text-center">
											<div class="col-md-12">
												<img src="/images/photos/award.png" alt="img" class="sales-img">
