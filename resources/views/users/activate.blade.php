                        ...
                        <div class="card">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Activate User</div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-md-12">
                                            ...
                                            <form action="{{ route('user.activating') }}" method="post">
                                            @csrf
                                            {{-- @method('PUT') --}}
                                            ...
                                            <input type="hidden" name="name" value="{{ $user->name }}">
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputEmail" class="col-md-3 form-label">Email (username)</label>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="card-footer text-right">
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-lg btn-primary">Activate</button>
                                                    <a href="{{ url()->previous() }}"
