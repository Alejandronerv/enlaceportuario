...
<div class="app-header header top-header">
    <div class="container">
        <div class="d-flex">
            <a class="header-brand text-left" href="{{ route('dashboard') }}">
                ...
                <img src="/images/brand/favicon1.png" class="header-brand-img darkmobile-logo" alt="CCTLink logo">
            </a>
                ...
                <div class="dropdown profile-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                        <div class="text-center">
                            <a href="#"
                                class="dropdown-item text-center user pb-0 font-weight-bold">{{ $name }}</a>
